var fast_feed   = 20   ; mm/s
var slow_feed   = 1    ; mm/s
var start_height = 2   ; mm
var settle_time = 0    ; s
var repeat      = 2    ; will do one fast probe followed by N slow probes
var tolerance   = 0.02 ; mm
var trigger     = 1000
var x_offset    = 0    ; mm
var y_offset    = 25   ; mm
var move_speed  = global.fast_move_feed

; breaking up the variables to meet line length requirements (160 char)
var slow = var.slow_feed * 60
var fast = var.fast_feed * 60
M558 H{var.start_height} F{var.fast, var.slow} T{var.move_speed} R{var.settle_time} A{var.repeat} S{var.tolerance} B1 K0
